...
This is a generated ditto.site clone app for https://superagi.com. It is a static Vite React project produced from captured DOM, CSS, assets, metadata, and interaction recipes.
...
`src/ditto` contains generated runtime utilities for captured interactions and motion. Current runtime utilities: DropdownMenu. Do not casually rewrite these files; they are plumbing that maps captured recipes to stable `data-ditto-id` anchors in delivered apps.
